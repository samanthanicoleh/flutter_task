...
abstract class $MovieCopyWith<$Res> {
  ...
  $Res call(
      {@HiveField(0) int id,
      @HiveField(1) @JsonKey(name: 'original_title') String originalTitle,
...
class _$_Movie implements _Movie {
  ...
  @override
  String toString() {
    return 'Movie(id: $id, originalTitle: $originalTitle, overview: $overview, voteAverage: $voteAverage, posterPath: $posterPath, genreIds: $genreIds, genres: $genres)';
  }
